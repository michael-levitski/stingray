const SERVICE_WORKER_PATH = location.hostname === 'michael-levitski.github.io' ? '/stingray/sw.js' : '/sw.js'
...
const promptUser = async e => {
    ...
    if (choice.outcome === 'accepted') {
        window.location = 'https://webplayer.stingray.com/'
    } 
}
